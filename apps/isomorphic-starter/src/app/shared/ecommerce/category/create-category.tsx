...
import SelectLoader from 'isomorphic-core/src/components/loader/select-loader';
import QuillLoader from 'isomorphic-core/src/components/loader/quill-loader';
import { Button, Input, Text, Title } from 'rizzui';
import cn from 'isomorphic-core/src/utils/class-names';
import { Form } from 'isomorphic-core/src/ui/form';
import {
  CategoryFormInput,
  categoryFormSchema,
} from '@/validators/create-category.schema';
import UploadZone from 'isomorphic-core/src/ui/file-upload/upload-zone';
const Select = dynamic(() => import('rizzui').then((mod) => mod.Select), {
  ssr: false,
  loading: () => <SelectLoader />,
});
const QuillEditor = dynamic(() => import('isomorphic-core/src/ui/quill-editor'), {
  ssr: false,
