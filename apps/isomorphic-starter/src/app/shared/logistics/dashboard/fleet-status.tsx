...
import HourGlassIcon from 'isomorphic-core/src/components/icons/hour-glass';
import WeighingScale from 'isomorphic-core/src/components/icons/weighing-scale';
