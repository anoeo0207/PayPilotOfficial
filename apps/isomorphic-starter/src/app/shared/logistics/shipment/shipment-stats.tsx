...
import { toCurrency } from 'isomorphic-core/src/utils/to-currency';
import ShipWithContainer from 'isomorphic-core/src/components/icons/ship-with-container';
import ShippingBox from 'isomorphic-core/src/components/icons/shipping-box';
import CargoPallet from 'isomorphic-core/src/components/icons/cargo-pallet';
import MoneyInHand from 'isomorphic-core/src/components/icons/money-in-hand';
import Containers from 'isomorphic-core/src/components/icons/containers';
