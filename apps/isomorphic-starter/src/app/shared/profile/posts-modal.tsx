...
import { Swiper, SwiperSlide, Pagination } from 'isomorphic-core/src/ui/carousel/carousel';
import { Title, Text, Button, Avatar, Textarea } from 'rizzui';
import SimpleBar from 'isomorphic-core/src/ui/simplebar';
import NextBtn from 'isomorphic-core/src/ui/carousel/next-btn';
import PrevBtn from 'isomorphic-core/src/ui/carousel/prev-btn';
import {
  PiChatTextBold,
  PiXBold,
  PiHeartBold,
